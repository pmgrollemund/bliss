...
```{r ,eval=TRUE, include = TRUE,fig.height=5,fig.width=7}
  ...
  image_Bliss(res_bliss$beta_posterior_density,param,q=1) + 
    lines_bliss(res_bliss$data$grids[[1]],res_bliss$smooth_estimate[[1]])+ 
    lines_bliss(res_bliss$data$grids[[1]],res_bliss$Bliss_estimate[[1]],col="purple")
```
...
Below, the function `lines_bliss` is used to plot the step function without the
vertical lines, linking differents steps.
